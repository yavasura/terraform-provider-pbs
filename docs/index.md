...
Full resource docs are available in [`docs/resources`](./resources).

Full data source docs are available in [`docs/data-sources`](./data-sources).
...
- The provider includes `pbs_notification_endpoint` and `pbs_notification_endpoints` data sources for reading notification endpoint configurations.
